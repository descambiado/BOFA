...
| Scripts | 78 |
| Flujos predefinidos | 19 (demo, recon, blue, web_recon, pentest_basic, vulnerability_scan, full_recon, vuln_triage, web_security_review, bug_bounty_web_light, bug_bounty_web_full, bug_bounty_web_params, bug_bounty_web_diff, blue_daily, blue_risk_assessment, forensics_quick, forensics_diff, ctf_binary_recon, ctf_network_recon) |
