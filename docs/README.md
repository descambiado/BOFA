...
This folder explains what BOFA is today, how to try it, and where the project is
going.
...
| Document | Why it matters |
|----------|----------------|
| [CORE_ARCHITECTURE.md](CORE_ARCHITECTURE.md) | How the runtime and core are structured |
| [CORE_USAGE.md](CORE_USAGE.md) | How to use BOFA from code |
| [INSTALLATION.md](INSTALLATION.md) | Full installation guidance |
| [USAGE.md](USAGE.md) | Broader platform usage references |
...
| Document | Why it matters |
|----------|----------------|
| [DOCUMENTATION_INDEX.md](DOCUMENTATION_INDEX.md) | Catalog of docs with short descriptions |
| [RELEASE.md](RELEASE.md) | Release and repo-metadata checklist |
| [REPORTS_CONVENTION.md](REPORTS_CONVENTION.md) | Expected reporting and artifact conventions |
