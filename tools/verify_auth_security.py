...
os.environ.setdefault("JWT_SECRET", "verify-only-secret-not-used-outside-smoke-tests")
...
def _check_legacy_default_retirement() -> None:
    db = _make_database()
    known_hash = hashlib.sha256("admin123".encode()).hexdigest()
    ...
    env.update(
        {
            ...
            "JWT_SECRET": "verify-only-secret-not-used-outside-smoke-tests",
...
def main() -> int:
    checks = [
        ...
        ("public admin/admin123 bootstrap is retired", _check_legacy_default_retirement),
